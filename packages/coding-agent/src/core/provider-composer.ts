...
function modelFromJson(
	...
	return {
		...
		inputLimits: definition.inputLimits ?? (inheritCatalogCapabilities ? defaults?.inputLimits : undefined),
		promptCache: definition.promptCache ?? (inheritCatalogCapabilities ? defaults?.promptCache : undefined),
		samplingParams: definition.samplingParams ?? (inheritCatalogCapabilities ? defaults?.samplingParams : undefined),
		headers: undefined,
		compat: mergeCompat(
			mergeCompat(
