...
/** Fired after retries, compaction, and queued messages drain, before the run settles. */
...
export interface BeforeAgentSettleEventResult {
	followUp?: {
		text: string;
...
export interface ExtensionAPI {
	...
	on(
		...
		handler: ExtensionHandler<BeforeAgentSettleEvent, BeforeAgentSettleEventResult>,
	): void;
